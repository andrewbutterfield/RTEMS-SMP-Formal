...
inline show_node0 () {
	printf("@@@ 0 PTR nptr %d\n" , nptr)
	printf("//@ 0.8444218515250481 \\<open>1\\<close> \\<open>41\\<close> \\<open>%d\\<close>\n" , nptr)
}
...
inline show_node1 () {
	...
	printf("@@@ 0 END nptr\n")
	printf("//@ 0.8444218515250481 \\<open>1\\<close> \\<open>45\\<close> \\<open>%d\\<close> \\<open>%d\\<close> \\<open>%d\\<close>\n" , nxt , prv , itm)
}
...
inline show_chain0 () {
	printf("@@@ 0 SEQ chain\n")
	printf("//@ 0.8444218515250481 \\<open>1\\<close> \\<open>67\\<close>\n")
}


inline show_chain1 () {
	printf("@@@ 0 SCALAR _ %d\n" , itm)
	printf("//@ 0.8444218515250481 \\<open>1\\<close> \\<open>71\\<close> \\<open>%d\\<close>\n" , itm)
}


inline show_chain2 () {
	printf("@@@ 0 END chain\n")
	printf("//@ 0.8444218515250481 \\<open>1\\<close> \\<open>75\\<close> \\<open>%d\\<close> \\<open>%d\\<close> \\<open>%d\\<close> \\<open>%d\\<close> \\<open>%d\\<close> \\<open>%d\\<close> \\<open>%d\\<close> \\<open>%d\\<close> \\<open>%d\\<close>\n" , memory0[0] , memory0[1] , memory0[2] , memory0[3] , memory0[4] , memory0[5] , memory0[6] , memory0[7] , cnp0)
}
...
inline doAppend0 () {
	...
	printf("//@ 0.8444218515250481 \\<open>1\\<close> \\<open>120\\<close> \\<open>%d\\<close> \\<open>%d\\<close>\n" , val , addr)
}
...
inline doNonNullGet0 () {
	...
	printf("//@ 0.8444218515250481 \\<open>1\\<close> \\<open>175\\<close> \\<open>%d\\<close>\n" , nptr)
}
